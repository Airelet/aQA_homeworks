list_of_all = [1, 2, 3, 4, 5, 6, 7, 8]  # We already know that it is a list so I suggest to name it like elements
list_of_even = []  # Same. I suggest to name it like event_elements
list_of_odd = []  # Same. I suggest to name it like odd elements
